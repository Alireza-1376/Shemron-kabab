...
const Scroll = () => {
    ...
    return (
        <div>
            ...
            <SearchItem />
            <div>
                <section className="scroll-mt-[130px] md:scroll-mt-[116px]" id="target-1">
                    <Kabab kabab={kabab} />
                </section>
                <section className="scroll-mt-32 md:scroll-mt-28" id="target-2">
                    <Rice rice={rice}/>
                </section>
                <section className="scroll-mt-32 md:scroll-mt-28" id="target-3">
                    <KababRice kababrice={kababrice}/>
                </section>
                <section className=" scroll-mt-32 md:scroll-mt-28" id="target-4">
                    <Salad salad={salad}/>
                </section>
                <section className="scroll-mt-32 md:scroll-mt-28 " id="target-5">
